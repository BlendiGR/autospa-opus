...
export default function DashboardCard({ title, value, icon, accentColor = 'blue' }: DashboardCardProps) {
    return (
        <div className="flex flex-col gap-2 p-5 border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start">
                ...
                <div className={`flex items-center justify-center w-12 h-12 rounded-xl ${accentStyles[accentColor]}`}>
                    {icon}
                </div>
            </div>
        </div>
